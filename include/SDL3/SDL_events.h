...
typedef struct SDL_PinchFingerEvent
{
    ...
    float span_x;        /**< The average X distance between each of the pointers forming the gesture in progress through the focal point. */
    float span_y;        /**< The average Y distance between each of the pointers forming the gesture in progress through the focal point. */
    float focus_x;        /**< The X coordinate of the current gesture's focal point. */
    float focus_y;        /**< The Y coordinate of the current gesture's focal point. */
    SDL_WindowID windowID; /**< The window underneath the finger, if any */
